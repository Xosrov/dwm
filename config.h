...
#include <X11/XF86keysym.h> // Fn keys
...
static const double activeopacity   = 0.975f;     /* Window opacity when it's focused (0 <= opacity <= 1) */
...
static const char col_gray4[]       = "#eeeeee";  	// lightest gray
static const char col_cyan[]        = "#f59542";	// accent color
